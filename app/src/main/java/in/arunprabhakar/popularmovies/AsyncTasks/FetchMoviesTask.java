package in.arunprabhakar.popularmovies.AsyncTasks;
...
import in.arunprabhakar.popularmovies.Config.Config;
import in.arunprabhakar.popularmovies.DataObjetcs.Movie;
import in.arunprabhakar.popularmovies.adapters.ImageAdapter;
import in.arunprabhakar.popularmovies.data.PopularMovieContract;
...
import static in.arunprabhakar.popularmovies.Config.Config.API_KEY;
...
public class FetchMoviesTask extends AsyncTask<String, Void, ArrayList<Movie>> {
    ...
    private ArrayList<Movie> extractData(String moviesJsonStr) throws JSONException {
        ...
        for(int i = 0; i < moviesLength; ++i) {
            ...
            FetchMoviesComponents fetchReviews = new FetchMoviesComponents(newMovie,"reviews");
            fetchReviews.execute();

            // fetch previews which will be stored as a JSON string
            // and add it to the new movie in new asyncTask
            FetchMoviesComponents fetchPreviews = new FetchMoviesComponents(newMovie,"videos");
